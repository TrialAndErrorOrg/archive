...
%    \noindent\textbf{Remark~\theremark. #1} \rmfamily}{\medskip}
   ...
   \paperpublished{September 30, 2023}
...
%\keywords{Formal theory, Scientific reform, Reproducibility, Replication, Multi-lab replications, Meta-hypothesis}
