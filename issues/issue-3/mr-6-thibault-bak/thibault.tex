...
\author[3]{Charlotte Pennington\orcid{0000-0002-5259-642X}}
\affil[3]{MRC Integrative Epidemiology Unit at the University of Bristol.}
\author[2,4]{Marcus Munafò\orcid{0000-0002-4049-993X}}
\affil[4]{School of Psychology, Aston University.}
\paperaccepted{April 12, 2023}
\paperpublished{May XX, 2023}
\paperpublisheddate{2023-05-01}
...
@article{COS2016,
    ...
    author      = {{COS}},
    url         = {https://web.archive.org/web/20230201000738/http://web.archive.org/screenshot/https://osf.io/tvyxz/wiki/1.\%20View\%20the\%20Badges/},
    date        = {2016},
    journal     = {OSF}
}
...
@article{ICMJE2021,
    ...
    author      = {{ICMJE}},
    url         = {http://www.icmje.org/journals-following-the-icmje-recommendations/},
    date        = {2021}
}
...
@article{Thibault2022,
    ...
    author      = {Thibault, R. T. and Hardwicke, T. E. and Sarafoglou, A. and Ioannidis, John P. A. and Munafo, M.},
    url         = {https://osf.io/x2dpn/},
    date        = {2022}
}
...
We propose that advocates for preregistration consider the following:
