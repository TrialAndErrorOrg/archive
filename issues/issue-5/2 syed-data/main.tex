...
\end{frontmatter}
	...
	\begin{tikzpicture}[remember picture, overlay]
		...
		at ([xshift=4.7cm, yshift=-0.3cm]current page.north west) 
		{
			...
			Incorrect Article Type Labeling: This article was previously mislabeled as an editorial article. This has now been corrected.\vspace{2pt} % Optional: adds a little space between text and line
	...
	\subsection{Preprinting Does Not Meet Science’s Duty of Care Responsibility to Society}
