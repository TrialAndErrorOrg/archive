...
\end{frontmatter}
	...
	\textbf{Keywords}: keratoconus, lamellar surgery, surgical safety, underpowered trial
	...
	\begin{table}
		\begin{tabularx}{\linewidth}{@{} l l l l l l l l l l l l l l l @{}}
			\hline \multicolumn{5}{l}{\textbf{Table 1: Baseline characteristics of both treatment groups}}
			\\
			...
			\hline
			\multicolumn{5}{l}{PET: partial endothelial trepanation. DALK: deep anterior lamellar keratoplasty. UCVA: uncorrected visual acuity. BCVA: best corrected visual acuity. D: diopter. *independent students t-test}
			\\
