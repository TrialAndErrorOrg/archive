...
\affil[1]{{\tiny Amsterdam Rheumatology and Immunology Center, Amsterdam UMC, location VUmc, Amsterdam, Netherlands}}
\affil[2]{{\tiny Epidemiology \& Data Science, Amsterdam UMC, Vrije Universiteit, Amsterdam, Netherlands}}
\affil[3]{{\tiny Department of Rheumatology and Clinical immunology, Maasstad Hospital, Rotterdam, Netherlands}}
\affil[4]{{\tiny Department of Rheumatology, Groene Hart Hospital, Gouda, Netherlands}}
\affil[5]{{\tiny Department of Rheumatology, Antonius Hospital, Sneek, Netherlands}}
\affil[6]{{\tiny Department of Rheumatology and Clinical Immunology, University Medical Center Utrecht, Utrecht, Netherlands}}
\affil[7]{{\tiny Department of Rheumatology, Gelre Hospitals, Apeldoorn, Netherlands}}
\affil[8]{{\tiny Department of Rheumatology, Leids University Medical Center, Leiden, Netherlands}}
\affil[9]{{\tiny Department of Rheumatology, Northwest Clinics, Alkmaar, Netherlands}}
\affil[10]{{\tiny Department of Rheumatology, Haga Hospital, Den Haag, Netherlands}}
\affil[11]{{\tiny Tools Patient Empowerment, Amsterdam, Netherlands}}
\affil[12]{{\tiny BeyonDevices LDA, Sobral de Monte Agra\c{c}o, Portugal}}
\affil[13]{{\tiny Bluepharma, Ind\'ustria Farmac\^eutica, S.A., Coimbra, Portugal}}
% List the correspondence email of the main correspondent
\corremail{\href{l.hartman@amsterdamumc.nl}{l.hartman@amsterdamumc.nl}}
\corraddress{Linda Hartman  \href{l.hartman@amsterdamumc.nl}{l.hartman@amsterdamumc.nl}}
 ...
 % Fill in the DOI of the paper % Always starts with '10.36850/' and is suffixed with one of the following plus a number % e : empirical % r : reflection % mr : meta - research % rga: rejected grant application % ed : editorial
