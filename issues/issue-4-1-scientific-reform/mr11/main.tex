...
@article{Ledgerwood2022,
    title       = {The pandemic as a portal},
    ...
    date        = {2022},
    pages       = {937--959},
    journal     = {Reimagining psychological science as truly open and inclusive. Perspectives on Psychological Science}
}
...
@article{Lewis2017,
    title       = {Reflections on {SIPS} (guest post by Neil Lewis, Jr.). The Hardest Science},
    author      = {Lewis, N.},
...
@article{Silversteininpress,
    title       = {A guide for social science journal editors on easing into open science},
    author      = {Silverstein, P. and Elman, C. and Montoya, A. K. and McGillivray, B. and Pennington, C. R. and Harrison, C. H. and Steltenpohl, C. and Roer, J. and Corker, K. and Charron, L. and Elsherif, M. and Malicki, M. and Hayes-Harb, R. and Grinschgl, S. and Neal, T. and Evans, T. and Karhulahti, V.-M. and Krenzer, W. and Belaus, A. and Moreau, D. and Syed, M.},
...
@article{Syed2019,
    title       = {The {O}pen {S}cience Movement is for all of us},
    author      = {Syed, M.},
    number      = {31234/osf.io/cteyb},
    volume      = {10},
    date        = {2019},
    journal     = {PsyArXiv}
}
...
\lettrine{I}{} am hoping that we can at least all agree that we have some problems with how we conduct our science. \emph{Serious problems}. In my home discipline of psychology, these problems include, but are not limited to, publication bias, low statistical power, p-hacking/questionable research practices/researcher degrees of freedom, HARKing, fraud, lack of diversity, weak measurement, weak theory, mistakes/sloppiness, jingle jangle fallacies, and problematic incentive structures \parencites{Chambers2017}{Spellman2015}{Syed2019}.\customfootnote{This article is based on a presentation given to the Purdue University Clinical Psychology Colloquium in November 2022. Slides and script of that talk, which serves as an earlier version of this paper, are available at \href{https://osf.io/ahu84/is}{https://osf.io/ahu84/is}.}
