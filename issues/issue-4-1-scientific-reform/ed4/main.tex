\documentclass[authordate, editorial, noabstract, issue]{jote-new-article}
...
\begin{document}
\pdfbookmark[0]{Field et al. (2024). Reflections on the Unintended Consequences of the Science Reform Movement}{3}
\begin{frontmatter}
  \maketitle
  \begin{abstract}
    \printabstracttext
